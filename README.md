...
Architecture follows the *Crafting Interpreters* model: source text →
...
```bash
./cvmpp                              # REPL
./cvmpp examples/fizzbuzz.cvm        # run a script
./cvmpp --debug examples/factorial.cvm   # disassemble bytecode, then run
```
